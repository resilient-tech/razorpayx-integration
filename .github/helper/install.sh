...
git clone "https://github.com/frappe/frappe" --branch "$BASE_BRANCH" --depth 1
...
bench get-app https://github.com/resilient-tech/razorpayx-integration.git --branch "$PR_BRANCH"
...
bench --verbose install-app "$APP_NAME"
